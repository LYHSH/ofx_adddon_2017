...
namespace fl2d {
    ...
    string flBlendMode::ADD = "add";
    string flBlendMode::ALPHA = "alpha";
    string flBlendMode::ALPHA_TEST = "alphaTest";
    string flBlendMode::DARKEN = "darken";
    string flBlendMode::DIFFERENCE_ = "difference";
    string flBlendMode::ERASE = "erase";
    string flBlendMode::HARDLIGHT = "hardlight";
    string flBlendMode::INVERT = "invert";
    string flBlendMode::LAYER = "layer";
    string flBlendMode::LIGHTEN = "lighten";
    string flBlendMode::MULTIPLY = "multiply";
    string flBlendMode::NORMAL = "normal";
    string flBlendMode::OVERLAY = "overlay";
    string flBlendMode::SCREEN = "screen";
    string flBlendMode::SHADER = "shader";
    string flBlendMode::SUBTRACT = "subtract";
    
    ofFbo* flBlendMode::_base = NULL;
    ofShader* flBlendMode::_blendShader = NULL;
    int flBlendMode::_width = 0;
    ...
    void flBlendMode::enable(string value) {
        ...
        if(value == flBlendMode::NORMAL) {
            //            glEnable(GL_BLEND);
            //            glBlendFunc(GL_ONE, GL_ZERO);
        }
        
        if(value == flBlendMode::ADD) {
            glEnable(GL_BLEND);
        ...
        if(value == flBlendMode::ALPHA) {
            glEnable(GL_BLEND);
            //        glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
            //        glBlendFuncSeparate(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA, GL_SRC_ALPHA, GL_ONE);
            glBlendFuncSeparate(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA, GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
        }
        if(value == flBlendMode::ALPHA_TEST) {
            //            glAlphaFunc(GL_GEQUAL, 0.1);
            glAlphaFunc(GL_GEQUAL, 1.0);
            glEnable(GL_ALPHA_TEST);
        }
        if(value == flBlendMode::DARKEN) {
            
        }
        if(value == flBlendMode::DIFFERENCE_) {
            
        }
        if(value == flBlendMode::ERASE) {
            
        }
        if(value == flBlendMode::HARDLIGHT) {
            
        }
        if(value == flBlendMode::INVERT) {
            
        }
        if(value == flBlendMode::LAYER) {
            
        }
        if(value == flBlendMode::LIGHTEN) {
            
        }
        if(value == flBlendMode::MULTIPLY) {
            
        }
        if(value == flBlendMode::OVERLAY) {
            
        }
        if(value == flBlendMode::SCREEN) {
            
        }
        if(value == flBlendMode::SHADER) {
            
        }
        if(value == flBlendMode::SUBTRACT) {
